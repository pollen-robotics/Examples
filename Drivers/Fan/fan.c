...
void fan_init(void) {
    fans[0] = luos_module_create(rx_fan_cb, STATE_MOD, "shoulder_fan");
    fans[1] = luos_module_create(rx_fan_cb, STATE_MOD, "elbow_fan");
    fans[2] = luos_module_create(rx_fan_cb, STATE_MOD, "wrist_fan");
